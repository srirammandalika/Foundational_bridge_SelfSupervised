...
def main():
    # Load datasets
    pneumoniamnist = np.load(os.path.join(DATA_DIR, 'pneumoniamnist.npz'))
    ...
    combined_images, combined_labels = combine_datasets(pneumoniamnist_data, pathmnist_data)
